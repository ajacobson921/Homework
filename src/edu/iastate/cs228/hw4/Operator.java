...
public class Operator implements Comparable<Operator>
{
	 ...
	 * or less than the inputPrecedence of the parameter operator op. Determines whether
	 * this operator on the stack should be output before pushing op onto the stack.
	 */
	@Override
	public int compareTo(Operator op)
	{ 	
		// TO DO
		return -100;  // TO MODIFY
	} 
